      ...
      >
        ...
        <Section heading="What is stored about you">
          <ul>
            ...
            <li>
              <strong>Events and announcements.</strong> Any event you post (title, time, location,
              description) and, if you are an admin, any announcement you post. Both are shown to the
              whole signed-in grade with your name attached as the poster.
            </li>
          </ul>
          <p>
        ...
        <Section heading="Who can see what">
          <ul>
            ...
            <li>
              <strong>Only you (or an admin) can edit or remove an event you posted,</strong> and only an
              admin can post, edit or remove an announcement. Same rule: enforced by the database, not
